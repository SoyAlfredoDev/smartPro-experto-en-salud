...
export const privacyPolicySections = [
  {
    ...
    paragraphs: [
      ...
      `${siteConfig.name} adopta de manera anticipada los principios y estándares de esta ley en sus procesos de cotización, asesoría y contacto con usuarios.`,
    ],
  },
  {
    id: "responsable",
    ...
    paragraphs: [
      `El responsable del tratamiento de los datos personales recabados a través de ${siteConfig.url} es ${siteConfig.legalName}, operando bajo la marca ${siteConfig.name}.`,
  ...
  },
  {
    ...
    list: [
      ...
      "Datos demográficos y de cotización: edad, sexo, ingreso, cargas familiares y preferencias de planes de salud.",
      "Datos de navegación y uso: dirección IP, tipo de dispositivo, navegador, páginas visitadas, cookies y eventos de interacción.",
      "Datos derivados de solicitudes de cotización o contacto con asesores vinculados a la plataforma.",
    ],
  },
  {
    id: "finalidades",
  ...
  },
  {
    ...
    list: [
      ...
      "Cotizador virtual y compañías de salud previsional, cuando usted solicite cotizar o contratar.",
